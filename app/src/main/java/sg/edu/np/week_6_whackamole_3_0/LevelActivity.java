...
public class LevelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user.setMyUserName(getIntent().getExtras().getString("username"));
    ...
    public void updateHighScore(String username, int level, int score){
        ...
        if(getHighScore < score) {
            ...
            this.user.setScores(myDBHandler.getAllScore(user.getMyUserName()));
            setmAdapter();
            mAdapter.reloadData();
        }
    }
    ...
    public void setmAdapter(){
        ...
        mAdapter = new Adapter(user,LevelActivity.this);
